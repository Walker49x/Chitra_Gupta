...
# Video file capture
video = cv2.VideoCapture(r"C:\Users\Priyanshu\PycharmProjects\Chitra_Gupta\assests\Delhi traffic nightmare- Tailback traffic near Vasant Kunj crossing.mp4")
